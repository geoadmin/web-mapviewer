...
describe('Test all SimpleUrlParamConfig class functionalities', () => {
    ...
    context('outputs the correct type with the readFromStore function', () => {
    ...
    context('outputs the correct type while reading values from the query', () => {
    ...
    context('Testing valuesAreDifferentBetweenQueryAndStore', () => {
        context('boolean', () => {
