 ...
 * @param {String|Number} swisstopoPyramidZoom a zoom level as desribed in http://api3.geo.admin.ch/services/sdiservices.html#wmts
 * @returns {Number} a web-mercator zoom level (as described in https://wiki.openstreetmap.org/wiki/Zoom_levels) or null if the input is not a valid swisstopo pyramid zoom level
 */
