 ...
 *
 * @returns {Fill | null} The default fill style.
 */
 ...
 *
 * @returns {import('../style/Image.js').default | null} The default image style.
 */
 ...
 *
 * @returns {Stroke | null} The default stroke style.
 */
 ...
 *
 * @returns {Text | null} The default text style.
 */
 ...
 *
 * @returns {Style | null} The default style.
 */
...
/**
 * A function that takes a url `{string}` and returns a url `{string}`. Might be used to change an
 * icon path or to substitute a data url obtained from a KMZ array buffer.
 *
 ...
 * @property {boolean} [extractStyles=true] Extract styles from the KML. Default is `true`
 * @property {boolean} [showPointNames=true] Show names as labels for placemarks which contain
 *   points. Default is `true`
 * @property {Style[]} [defaultStyle] Default style. The default default style is the same as Google
 *   Earth.
 * @property {boolean} [writeStyles=true] Write styles into KML. Default is `true`
 * @property {null | string} [crossOrigin='anonymous'] The `crossOrigin` attribute for loaded
 *   images. Note that you must provide a `crossOrigin` value if you want to access pixel data with
 *   the Canvas renderer. Default is `'anonymous'`
 * @property {IconUrlFunction} [iconUrlFunction] Function that takes a url string and returns a url
 *   string. Might be used to change an icon path or to substitute a data url obtained from a KMZ
 *   array buffer.
 */
...
class KML extends XMLFeature {
    ...
    constructor(options) {
        ...
        /**
         * @private
         * @type {!Object<string, Style[] | string>}
         */
        this.sharedStyles_ = {}
     ...
     * @returns {Feature[] | undefined} Features.
     */
     ...
     * @param {any[]} objectStack Object stack.
     * @returns {Feature | undefined} Feature.
     */
    ...
    /**
     * @typedef {Object} KMLCamera Specifies the observer's viewpoint and associated view
     *   parameters.
 ...
 * @param {!Object<string, Style[] | string>} sharedStyles Shared styles.
 * @param {boolean | undefined} showPointNames True to show names for point placemarks.
 * @returns {import('../style/Style.js').StyleFunction} Feature style function.
 */
...
/**
 * @param {Node} node Node.
 * @returns {import('../color.js').Color | undefined} Color.
 */
...
/**
 * @param {Node} node Node.
 * @returns {number[] | undefined} Flat coordinates.
 */
...
/**
 * @param {Node} node Node.
 * @returns {number | undefined} Scale.
 */
 ...
 * @param {Element} node Node.
 * @param {any[]} objectStack Object stack.
 * @returns {Style[] | string | undefined} StyleMap.
 * @this {KML}
 */
 ...
 * @param {Element} node Node.
 * @param {any[]} objectStack Object stack.
 * @returns {number[]} LinearRing flat coordinates.
 */
 ...
 * @param {Element} node Node.
 * @param {any[]} objectStack Object stack.
 * @returns {MultiLineString | undefined} MultiLineString.
 */
 ...
 * @param {Element} node Node.
 * @param {any[]} objectStack Object stack.
 * @returns {LineString | undefined} LineString.
 */
 ...
 * @param {Element} node Node.
 * @param {any[]} objectStack Object stack.
 * @returns {Polygon | undefined} Polygon.
 */
...
/**
 * Reads an array of geometries and creates arrays for common geometry properties. Then sets them to
 * the multi geometry.
 *
 * @param {MultiPoint | MultiLineString | MultiPolygon} multiGeometry A multi-geometry.
 * @param {import('../geom/Geometry.js').default[]} geometries List of geometries.
 */
...
/**
 * @param {Element} node Node.
 * @param {{ name: any; value: any }} pair Name value pair.
 * @param {any[]} objectStack Object stack.
 */
 ...
 *
 * @constant
 * @type {function( any , ( any )[]): (Node|undefined)}
 */
const DATA_NODE_FACTORY = makeSimpleNodeFactory('Data')

/**
 * @param {Element} node Node.
 * @param {{ names: string[]; values: any[] }} namesAndValues Names and values.
 * @param {any[]} objectStack Object stack.
 */
...
/**
 * FIXME currently we do serialize arbitrary/custom feature properties (ExtendedData).
 *
 * @param {Element} node Node.
 * @param {Feature} feature Feature.
 * @param {any[]} objectStack Object stack.
