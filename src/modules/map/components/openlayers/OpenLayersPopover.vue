...
import { inject, onMounted, onUnmounted, ref, toRef, watch } from 'vue'
...
const authorizePrint = toRef(props, 'authorizePrint')
const title = toRef(props, 'title')
const useContentPadding = toRef(props, 'useContentPadding')
