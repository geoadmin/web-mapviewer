...
export const TILEGRID_ORIGIN = [558147.80, 6152731.53]; // [2420000, 1350000] projected from EPSG:2056 to EPSG:3857
export const TILEGRID_RESOLUTIONS = [4000, 3750, 3500, 3250, 3000, 2750, 2500, 2250, 2000, 1750, 1500, 1250, 1000, 750, 650, 500, 250, 100, 50, 20, 10, 5, 2.5, 2, 1.5, 1, 0.5, 0.25, 0.1];
