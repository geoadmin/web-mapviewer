// update-pnpm-workspace.js
// Requires: Node 18+ (global fetch) and `yaml` package
// Install: pnpm add -D yaml
//
// Usage:
//   node scripts/update-catalog-to-latest.js pnpm-workspace.yaml [--dry-run] [--same-major]
//       [--registry <url>] [--tag <dist-tag>] [--concurrency <n>]
//
// Example:
//   node scripts/update-catalog-to-latest.js pnpm-workspace.yaml --dry-run
//   node scripts/update-catalog-to-latest.js pnpm-workspace.yaml --same-major
//   node scripts/update-catalog-to-latest.js pnpm-workspace.yaml --registry https://registry.npmjs.org --tag latest
...
function loadYamlDocument(file) {
...
function setCatalogEntry(doc, catalogNode, name, value) {
...
async function fetchPackageMeta(registry, pkg) {
...
function sameMajorTarget(base, allVersions) {
