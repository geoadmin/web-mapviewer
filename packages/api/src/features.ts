...
async function identifyOnGeomAdminLayer(identifyConfig: IdentifyConfig): Promise<LayerFeature[]> {
    const {
        layer,
        projection,
        coordinate,
 ...
 */
function identify(config: IdentifyConfig): Promise<LayerFeature[]> {
    const {
        layer,
        coordinate,
        mapExtent,
