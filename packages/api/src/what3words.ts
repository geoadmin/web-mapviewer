...
function isWhat3WordsString(text: string): boolean {
 ...
 */
function retrieveWhat3WordsLocation(
 ...
 */
function registerWhat3WordsLocation(
...
export const what3wordsAPI = {
    isWhat3WordsString,
    retrieveWhat3WordsLocation,
    registerWhat3WordsLocation,
}
export default what3wordsAPI
