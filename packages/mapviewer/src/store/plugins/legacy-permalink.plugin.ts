import type { CoordinateSystem, SingleCoordinate } from '@geoadmin/coordinates'
...
import { transformLayerIntoUrlString } from '@/router/storeSync/layersParamParser.ts'
import {
    EMBED_VIEW,
...
import usePositionStore, { type CameraPosition } from '@/store/modules/position.store.ts'
import { FeatureInfoPositions } from '@/store/modules/ui.store.ts'
import {
    getKmlLayerFromLegacyAdminIdParam,
    getLayersFromLegacyUrlParams,
    handleLegacyFeaturePreSelectionParam,
    isLegacyParams,
} from '@/utils/legacyLayerParamUtils.ts'
