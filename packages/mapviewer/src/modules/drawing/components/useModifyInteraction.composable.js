import { altKeyOnly, doubleClick, primaryAction, singleClick } from 'ol/events/condition'
...
export default function useModifyInteraction(features) {
    ...
    const modifyInteraction = new ModifyInteraction({
        ...
        deleteCondition: (event) =>
            (isPhoneMode.value && doubleClick(event)) || (singleClick(event) && altKeyOnly(event)),
