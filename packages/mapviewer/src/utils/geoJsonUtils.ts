...
import { CoordinateSystem, WGS84, type SingleCoordinate } from '@geoadmin/coordinates'
 ...
 *   array)
 */
export function getGeoJsonFeatureCenter(
...
export function getExtentOfGeometries(geometries: Geometry[]): NormalizedExtent | undefined {
    ...
    if (geometriesExtent.length === 4) {
        return normalizeExtent(geometriesExtent)
    }
    return undefined
}
