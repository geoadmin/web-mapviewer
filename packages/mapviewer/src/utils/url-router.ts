...
function decode(text: string): string {
    try {
        ...
        log.error(`Error decoding "${text}". Using original value`, error)
    }
    return '' + text
}
...
/**
 * Stringifies a {@link LocationQuery} object. Like `URLSearchParams`, it doesn't prepend a `?`
 *
...
export function readSingleParamAsString(query: LocationQuery, name: string): string | undefined {
