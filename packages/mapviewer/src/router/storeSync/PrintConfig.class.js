...
import AbstractParamConfig, { STORE_DISPATCHER_ROUTER_PLUGIN } from '@/router/storeSync/abstractParamConfig.class'
...
function generatePrintConfigForUrl(store) {
    if (store.state.print.config.layout !== 'A4_L') {
...
/** Describe the print config in the URL. Used by our headless print service to set up the viewer before printing. */
