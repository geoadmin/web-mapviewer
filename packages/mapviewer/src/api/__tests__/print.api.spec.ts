...
import { PrintLayout, PrintLayoutAttribute } from '../print.api'
...
describe('Print API unit tests', () => {
    ...
    describe('PrintLayout tests', () => {
        it('Filters out invalid attributes inputs', () => {
            const testInstance = new PrintLayout('test', null, undefined)
        ...
        it('gets the scales from the "map" attribute correctly', () => {
            ...
            const scalesInMapAttr = new PrintLayout(
                ...
                new PrintLayoutAttribute('map', null, null, null, {
                    scales,
                    dpiSuggestions: [],
                    height: 0,
                    width: 0,
