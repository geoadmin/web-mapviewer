import log from '@/log'
import { CoordinateSystem, LV03, LV95, WEBMERCATOR } from '@/proj'
 ...
 */
const registerProj4 = (proj4 : typeof import('proj4'), projections: CoordinateSystem[] = [WEBMERCATOR, LV95, LV03]): void => {
