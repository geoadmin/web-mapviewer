 ...
 *
 * @param value
 * @param decimals How many decimals after the separator must be present after rounding
 *   (default to 0)
 ...
 * @returns The closest value, from the list of integer, matching the floating number (will
