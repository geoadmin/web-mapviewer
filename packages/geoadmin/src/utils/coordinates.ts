...
import { formatThousand, isNumber, round } from '@/utils/numbers'
 ...
 * @param [withThousandsSeparator=true] If thousands should be separated with a single quote character
...
export function wrapXCoordinates<T extends SingleCoordinate | SingleCoordinate[]>(
    ...
    if (
        projection instanceof StandardCoordinateSystem &&
        projection.bounds &&
