...
describe('WMTSCapabilitiesParser of wmts-ogc-sample.xml', () => {
    ...
    it('Parse layer attributes', () => {
        // General layer
        let layer = parser.getExternalLayerObject('BlueMarbleSecondGenerationAG', WGS84)
        ...
        layer = parser.getExternalLayerObject('BlueMarbleThirdGenerationZH', WGS84)
    ...
    it('Parse layer time dimension in format YYYYMMDD', () => {
        ...
        expect(timeConfigUtils.hasTimestamp(layer!.timeConfig!, '20110805')).to.be.true
        expect(timeConfigUtils.hasTimestamp(layer!.timeConfig!, '20081024')).to.be.true
        expect(timeConfigUtils.hasTimestamp(layer!.timeConfig!, '20081023')).to.be.false

        expect(timeConfigUtils.getTimeEntryForYear(layer!.timeConfig!, 2008)).to.be.not.null.and.not
            .undefined
        expect(timeConfigUtils.getTimeEntryForYear(layer!.timeConfig!, 2005)).to.be.undefined
