    ...
    >
        ...
        <Teleport to="body">
            <div
                ...
                class="floating tw:z-100 tw:border tw:rounded-sm"
                :class="{
                    'tw:bg-gray-900': theme === 'light',
            ...
            >
                ...
                <div
                    ...
                    :style="arrowStyle"
                    class="arrow tw:fixed tw:h-0 tw:w-0"
...
.arrowUp:after {
    ...
    border-left: 8px solid transparent;
    border-right: 8px solid transparent;
    border-bottom: 8px solid var(--color-gray-700);
}
...
.arrowRight:after {
    ...
    border-top: 8px solid transparent;
    border-bottom: 8px solid transparent;
    border-left: 8px solid var(--color-gray-700);
}
...
.arrowLeft:after {
    ...
    border-top: 8px solid transparent;
    border-bottom: 8px solid transparent;
    border-right: 8px solid var(--color-gray-700);
}
...
.arrowDown:after {
    ...
    border-left: 8px solid transparent;
    border-right: 8px solid transparent;
    border-top: 8px solid var(--color-gray-700);
}
</style>
