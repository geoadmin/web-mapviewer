...
/**
 * Changes the color used to fill the feature. Only change the color if the feature is editable,
...
export default function changeFeatureColor(
    ...
    const wantedColor = allStylingColors.find((styleColor) => styleColor.name === color.name)
