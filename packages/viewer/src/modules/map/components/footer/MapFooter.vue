...
<template>
    ...
    >
        <div
            v-if="hasTopLeftFooter || hasTopRightFooter"
            class="map-footer-top"
        >
            <slot name="top-left" />
            <span
                v-if="hasTopRightFooter"
                class="map-footer-top-spacer"
            />
            <slot name="top-right" />
        </div>
        ...
        >
            <slot
                name="bottom-left"
                @vue:updated="handleSlotChange"
            />
            <span
                v-if="hasBottomRightFooter"
                class="map-footer-bottom-spacer"
            />
