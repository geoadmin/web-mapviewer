...
declare global {
    namespace Cypress {
        ...
        interface Chainable {
             ...
             * @param options.olMap Optional flag to wait for the OpenLayers map to be ready. Default to true.
             */
             ...
             *
             * @param layer A layer's metadata, that usually come from the fixture layers.fixture.json
             ...
             * @param withHash Optional flag to set if legacy (withHash=false) or new (withHash=true) URL should be used.
             */
